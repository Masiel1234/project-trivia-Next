...
export const EditProfileForm = ({ form, handleChange, handleSubmit }: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        <label aria-label='name' className="block text-sm font-medium text-gray-700 mb-1">
          {t('name')}
        </label>
        <InputField
          type="text"
      ...
      <div>
        <label aria-label='email' className="block text-sm font-medium text-gray-700 mb-1">
          {t('email')}
        </label>
        <InputField
          type="email"
